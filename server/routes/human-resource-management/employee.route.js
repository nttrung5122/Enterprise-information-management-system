...
router.post('/updateCheckIn',EmployeeController.updateCheckIn)
router.get('/getCheckInMonth',EmployeeController.getCheckInMonth)
router.get('/getCheckedInByDay',EmployeeController.getCheckedInByDay)
